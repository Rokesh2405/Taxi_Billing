...
<html lang="en-IN">
    <head>
        <meta charset="UTF-8">
        <title>Droptaxi Billing | Login</title>
    ...
    <body class="login-page  ">
        <div class="login-box ">
            <div class="login-logo">
                ...
                <a href="#"><h3>Droptaxi Billing<!-- <img src="<?php echo $sitename; ?>pages/profile/image/1532344513.png" /> --></h3></a>
            </div><!-- /.login-logo -->
