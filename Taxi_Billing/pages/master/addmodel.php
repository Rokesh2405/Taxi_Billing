...
if (isset($_REQUEST['submit'])) {
    ...
    $msg = addmodel($model,$status,$getid);
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>master/model.htm"><i class="fa fa-circle-o"></i> Model</a></li>
            <li class="active"><?php
                if ($_REQUEST['id'] != '') {
                    echo 'Edit';
                } else {
        ...
        <form name="department" id="department"  method="post" enctype="multipart/form-data">
            <div class="box box-info">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Model Name<span style="color:#FF0000;">*</span></label>
							 <input type="text"  required="required" name="model" id="model" placeholder="Enter Model Name" autocomplete="off" class="form-control" value="<?php echo getmodel('model',$_REQUEST['id']); ?>" />
                        </div>
                          <div class="col-md-6">
                            <label>Status</label>
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>master/model.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-6">
