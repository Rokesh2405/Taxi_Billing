...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Do you want to delete the Package(s)"))
            {
                return true;
            }
            else
...
<style type="text/css">
    .row { margin:0;}
    #normalexamples tbody tr td:nth-child(2), tr td:nth-child(3),  tbody tr td:nth-child(6),tbody tr td:nth-child(7),tbody tr td:nth-child(8),tbody tr td:nth-child(9) {
        text-align:left;
        font-size: 19px;
    }
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Package
            <small>List of Package(s)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="#"><i class="fa fa-asterisk"></i>Master(s)</a></li>
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i>Package Mgmt</a></li>            
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>master/addpackage.htm">Add New Package</a></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editpackage.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        "searching": true,
	"ordering":false,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=packagetable"
    });
</script>