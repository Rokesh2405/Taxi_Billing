...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Do you want to delete the Customer(s)"))
            {
                return true;
            }
            else
...
<style type="text/css">
    .row { margin:0;}
    #normalexamples tbody tr td:nth-child(1), tbody tr td:nth-child(2),tbody tr td:nth-child(3),tbody tr td:nth-child(4),tbody tr td:nth-child(5),tbody tr td:nth-child(6) {
        text-align:center;
        font-size: 19px;
    }
	 #normalexamples tbody tr td:nth-child(1), tbody tr td:nth-child(2),tbody tr td:nth-child(3),tbody tr td:nth-child(4) {
        text-align:left;
        font-size: 19px;
    }
</style>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i>Customer Mgmt</a></li>            
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>master/addcustomer.htm">Add New Customer</a></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php echo $msg; ?>
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        "searching": true,
	    "ordering":false,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=financecustomertbale"
    });
</script>