...
$msg = addcustomer1($credit_limit_days,$credit_limit_amt,$emailid,$cusid,$name,$contact_person,$mobileno,$area,$city,$state,$pincode,$gst,$address,$status,$getid);
}
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label>Company Name / Customer Name<span style="color:#FF0000;">*</span></label>
                         ...
                         <div class="col-md-4">
                            ...
                            <input type="text"  name="contact_person" id="name" placeholder="Enter Contact Person Name" class="form-control" value="<?php echo stripslashes(getcustomer('contact_person',$_REQUEST['cid'])); ?>" />
                        </div>
                          <div class="col-md-4">
                            <label>Emailid</label>
                            <input type="email" name="emailid" id="emailid" placeholder="Enter Emailid" class="form-control" value="<?php echo stripslashes(getcustomer('emailid',$_REQUEST['cid'])); ?>" />
                        </div>
                     ...
                     <div class="row">
                         <div class="col-md-4">
                            ...
                            <input type="number"  required="required" name="mobileno" id="mobileno" placeholder="Enter Mobile Number" class="form-control" value="<?php echo stripslashes(getcustomer('mobileno',$_REQUEST['cid'])); ?>" />
                        </div>
                         
                           <div class="col-md-4">
                            <label>City <span style="color:#FF0000;">*</span></label>
                            <input type="text"  required="required" name="city" id="mobileno" placeholder="Enter City" class="form-control" value="<?php echo stripslashes(getcustomer('city',$_REQUEST['cid'])); ?>" />
                        </div>
<div class="col-md-4">
                            <label>State <span style="color:#FF0000;">*</span></label>
                            <input type="text"  required="required" name="state" id="state" placeholder="Enter State" class="form-control" value="<?php echo stripslashes(getcustomer('state',$_REQUEST['cid'])); ?>" />
                        </div>
                     </div>
                         <div class="clearfix"><br /></div>
                     <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text"  required="required" name="pincode" id="pincode" placeholder="Enter Pincode" class="form-control" value="<?php echo stripslashes(getcustomer('pincode',$_REQUEST['cid'])); ?>" />
                        </div>
                      <!--   <div class="col-md-4">
                            <label>GST No </label>
                            <input type="text" name="gst" id="gst" placeholder="Enter GST No " class="form-control" value="<?php echo stripslashes(getcustomer('gst',$_REQUEST['cid'])); ?>" />
                        </div> -->
                     <div class="col-md-4">
                            <label>Status <span style="color:#FF0000;">*</span></label>
                            <select name="status" class="form-control">
                             <option value="">Select</option>
                             <option value="1" <?php if(getcustomer('status',$_REQUEST['cid'])=='1') { ?> selected="selected" <?php } ?>>Active</option>  
                             <option value="0" <?php if(getcustomer('status',$_REQUEST['cid'])=='0') { ?> selected="selected" <?php } ?>>Inactive</option>  
                            </select>
