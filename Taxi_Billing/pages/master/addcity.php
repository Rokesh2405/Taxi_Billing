...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>master/model.htm"><i class="fa fa-circle-o"></i> City</a></li>
            <li class="active"><?php
                if ($_REQUEST['id'] != '') {
                    echo 'Edit';
                } else {
        ...
        <form name="department" id="department"  method="post" enctype="multipart/form-data">
            <div class="box box-info">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>City Name<span style="color:#FF0000;">*</span></label>
							 <input type="text"  required="required" name="city" id="city" placeholder="Enter City Name" autocomplete="off" class="form-control" value="<?php echo getcity('city',$_REQUEST['id']); ?>" />
                        </div>
                          <div class="col-md-6">
                            <label>Status</label>
                          
                          <select name="status" class="form-control">
                         <option value="1" <?php if(getcity('status', $_REQUEST['id'])=='1') { ?> selected="selected"<?php } ?>>Active</option>      
                         <option value="0" <?php if(getcity('status', $_REQUEST['id'])=='0') { ?> selected="selected"<?php } ?>>Inactive</option>      
                          </select>
                      </div>
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>master/city.htm">Back to Listings page</a>
                        </div>
                        <div class="col-md-6">
