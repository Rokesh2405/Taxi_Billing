...
$msg = addpurchasereturn($mrp_price1,$hsn1,$oid1,$bill_no,$supplierid, $date, $netweight, $amount, $status,$object1, $quantity1,$rate1,$tamount1, $sub_total,$discount,$tot_amt,$payment_type,$advance_amount,$balance_amount,$getid);
}
...
if($getrecr['id']==''){
  ...
  $object1 = $db->prepare("SELECT * FROM `temp_purchase_detail` WHERE `object_id`= ?");
        ...
        <td style="border: 1px solid #f4f4f4;"><input type="text" style="text-align: right;" name="quantity[]" id="quantity[]" pattern="[0-9]+" class="form-control quantity" value="<?php echo $object1list['pquantity']; ?>" onkeyup="quantitycalculation(this.value)"/><input type="hidden" name="qtyhidden" id="qtyhidden" value="" /></td>
         <td style="border: 1px solid #f4f4f4;"><input type="text" style="text-align: right;" name="mrp_price[]" id="mrp_price" class="form-control mrp_price" readonly="readonly" value="<?php echo $object1list['mrp_price']; ?>"></td>

        <td style="border: 1px solid #f4f4f4;"><input type="text" style="text-align: right;" name="rate[]" id="rate[]" readonly="readonly" class="form-control rate" value="<?php echo $object1list['rate']; ?>" onkeyup="quantitycalculation(this.value)"/><input type="hidden" name="ratehidden" id="ratehidden" value="" /></td>
...
<td style="border: 1px solid #f4f4f4;"><input type="number" style="text-align: right;" name="rate[]" id="rate[]" class="form-control rate" readonly="readonly" /><input type="hidden" name="ratehidden" id="ratehidden" value="" onkeyup="quantitycalculation(this.value)"/></td>
...
<td style="border: 1px solid #f4f4f4;"><input type="text" style="text-align: right;" name="quantity[]" id="quantity[]" class="form-control quantity" value="" /><input type="hidden" name="qtyhidden" id="qtyhidden" pattern="[0-9]+" onkeyup="quantitycalculation(this.value)"/></td>
     ...
     <td style="border: 1px solid #f4f4f4;"><input type="number" style="text-align: right;" name="mrp_price[]" id="mrp_price" class="form-control mrp_price" readonly="readonly" value="" /></td>
                                               
<td style="border: 1px solid #f4f4f4;"><input readonly="readonly" type="number" style="text-align: right;" name="rate[]" id="rate[]" class="form-control rate" value="" /><input type="hidden" name="ratehidden" id="ratehidden" value="" onkeyup="quantitycalculation(this.value)"/></td>
