...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>pages/process/onlineorder.php"><i class="fa fa-circle-o"></i> Point Of Sale</a></li>
            <!-- <li class="active"><?php
                if ($_REQUEST['lid'] != '') {
                    echo 'Edit';
                } else {
...
{
?>
 <option value="<?php echo $customerfetch['id']; ?>" <?php if(getsales("customer_id", $_REQUEST['lid'])==$customerfetch['id'] || $customerfetch['id']==$_REQUEST['pid']) { ?> selected="selected" <?php } ?>><?php echo $customerfetch['name']; ?></option>
<?php } ?>							
							 </select>
...
<select name="order_method" class="form-control" required="required" style="margin-top: 16px;width:fit-content;" <?php if($_REQUEST['type']=='view') { ?> readonly="readonly" <?php } ?>>
...
{
?>
 <option value="<?php echo $ordermethodfetch['id']; ?>" <?php if(getsales("order_method", $_REQUEST['lid'])==$ordermethodfetch['id']) { ?> selected="selected" <?php } ?>><?php echo $ordermethodfetch['ordertype']; ?></option>
<?php } ?>                          
 ...
 <label>Order Type <span style="color:#FF0000;">*</span></label>                                  
						...
						<!-- <div class="col-md-2">
                             <label>Bill Type <span style="color:#FF0000;">*</span></label>   
						<select name="billtypemast" id="billtype" class="form-control" required="required"  style="margin-top: 16px;" <?php if($_REQUEST['type']=='view') { ?> readonly="readonly" <?php } ?>>
                        <option value="">Select</option>
                       <option value="1" <?php
                                if (getsales('billtypemast', $_REQUEST['lid']) == '1') {
                                    echo 'selected';
                                }
                                ?>>Cash Bill</option>
                                <option value="2"  <?php
                                if (getsales('billtypemast', $_REQUEST['lid']) == '2') {
                                    echo 'selected';
                                }
                                ?>>Credit Bill</option>
                        </select> -->
...
<select name="gsttype" id="gsttype" class="form-control" required="required" style="margin-top: 16px;width:fit-content;" <?php if($_REQUEST['type']=='view') { ?> readonly="readonly" <?php } ?>>
                        <option value="1" <?php
                                if (getsales('gsttype', $_REQUEST['lid']) == '1') {
                                    echo 'selected';
                                }
                                ?>>With GST</option>
                        <option value="2" <?php
                                if (getsales('gsttype', $_REQUEST['lid']) == '2') {
                                    echo 'selected';
                                }
                                ?>>Without GST</option>
                        </select>                           
    ...
    <table width="100%">
                        ...
                        <?php if($_REQUEST['type']!='view') { ?>
                        &nbsp;&nbsp;&nbsp;<label>Manual Bill</label>&nbsp;<input type="checkbox" name="billtype" id="chkRead" value="1" <?php if(getsales('billtype',$_REQUEST['lid'])=='1') { ?> checked="checked" <?php } ?>> 
                    ...
                    <?php } ?>
                        ...
                        <tr>
                        <td colspan="2"><input type="text" class="form-control"  <?php if(getsales('billtype',$_REQUEST['lid'])!='1') { ?> readonly="" <?php } ?> name="bill_no" id="bill_no" style="width:fit-content;" required="required"  value="<?php if($_REQUEST['lid']!=''){ echo getsales('bill_number',$_REQUEST['lid']); } else { $customerid1 = FETCH_all("SELECT  * FROM `online_order` WHERE `id`!=? ORDER BY `id` DESC", 0);
...
{
?>
 <option value="<?php echo $salesmanfetch['id']; ?>" <?php if(getsales("salesman", $_REQUEST['lid'])==$salesmanfetch['id']) { ?> selected="selected" <?php } ?>><?php echo $salesmanfetch['name']; ?></option>
<?php } ?>                          
                             </select>
                      <?php } ?>       
                    </div>
		...
		<input type="text" <?php if($_REQUEST['type']=='view') { ?> readonly="readonly" <?php } ?>  style="text-align: right;" name="quantity[]" id="quantity[]" pattern="[0-9]+" class="form-control quantity" value="<?php echo $object1list['qty']; ?>" onkeyup="quantitycalculation(this.value)"/><input type="hidden" name="qtyhidden" id="qtyhidden" value="" /></td>
         <td><input type="text" style="text-align: right;" name="mrp_price[]" readonly="readonly" id="mrp_price" class="form-control mrp_price" value="<?php echo $object1list['mrp_price']; ?>" /></td>
        <td><input type="text" style="text-align: right;" name="rate[]" readonly="readonly"  id="rate[]" class="form-control rate" value="<?php echo $object1list['rate']; ?>" onkeyup="quantitycalculation(this.value)"/><input type="hidden" name="ratehidden" id="ratehidden" value="" /></td>
        <td><input type="text" style="text-align: right;" name="total[]" <?php if($_REQUEST['type']=='view') { ?> readonly="readonly" <?php } ?>  id="total[]" class="form-control total" value="<?php echo $object1list['total']; ?>" onkeyup="quantitycalculation(this.value)"/><input type="hidden" name="qtyhidden" id="qtyhidden" value="" /></td>
                                                            ...
                                                            <td <?php if($_REQUEST['type']!='view') { ?>  onclick="delrec1($(this), '<?php echo $object1list['id']; ?>')"  <?php } ?>><i class="fa fa-trash fa-2x" style="color:#F00;cursor:pointer;"></i></td>
                                                        </tr>
                                                        <?php
                                                        $b++;
                                                    }
...
<td><input type="text" style="text-align: right;" readonly="readonly" name="mrp_price[]" id="mrp_price" class="form-control mrp_price" value="" /></td>                                                    
<td><input type="text" style="text-align: right;" readonly="readonly" name="rate[]" id="rate[]" class="form-control rate" value="" /><input type="hidden" name="ratehidden" id="ratehidden" value="" onkeyup="quantitycalculation(this.value)"/></td>
...
<td><input type="text" style="text-align: right;" name="total[]" id="total" class="form-control total"/><input type="hidden" name="totalhidden" id="totalhidden" value="" onkeyup="quantitycalculation(this.value)"/></td>
										        ...
										        <tr id="firsttasktr" style="display:none">
                                                    ...
                                                    <td>
													<input type="hidden" name="oid[]" value="">
                                                          <input type="hidden" name="gstresult[]" id="gstresult">
													<input type="text" name="objectval[]" id="objectval" class="form-control objectchange">
                                                    ...
                                                    <td><input type="text" style="text-align: right;" name="hsn[]" id="hsn" class="form-control" value="" /></td>
<td><input type="text" style="text-align: right;" name="quantity[]" id="quantity[]" class="form-control quantity" value="" /><input type="hidden" name="qtyhidden" id="qtyhidden" pattern="[0-9]+" onkeyup="quantitycalculation(this.value)"/></td>
<td><input type="text" style="text-align: right;" name="mrp_price[]" readonly="readonly" id="mrp_price" class="form-control mrp_price" value="" /></td>
                                          
<td><input type="text" style="text-align: right;" name="rate[]" readonly="readonly" id="rate[]" class="form-control rate" value="" /><input type="hidden" name="ratehidden" id="ratehidden" value="" onkeyup="quantitycalculation(this.value)"/></td>
...
{
?>
 <option value="<?php echo $paymentmodefetch['id']; ?>" <?php if(getsales("payment_mode", $_REQUEST['lid'])==$paymentmodefetch['id']) { ?> selected="selected" <?php } ?>><?php echo $paymentmodefetch['paymentmode']; ?></option>
<?php } ?>
  ...
  <tr>
    <td  <?php if(getsales("billtypemast", $_REQUEST['lid'])=='2') { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?> id="bil1">Advance Amount:</td>
    <td <?php if(getsales("billtypemast", $_REQUEST['lid'])=='2') { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?> id="bil2"><input type="text" name="bill_advanceamt" <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?> class="form-control"  id="bill_advanceamt" value="<?php echo getsales("bill_advanceamt", $_REQUEST['lid']); ?>">
</td>
</tr>
 <tr>
    <td <?php if(getsales("billtypemast", $_REQUEST['lid'])=='2') { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?> id="bil3">Balance Amount:</td>
    <td <?php if(getsales("billtypemast", $_REQUEST['lid'])=='2') { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?> id="bil4"><input type="text" class="form-control" name="bill_balanceamt" <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?> id="bill_balanceamt" value="<?php echo getsales("bill_balanceamt", $_REQUEST['lid']); ?>">
</td>
</tr>
</table>
...
<table border="1" cellpadding="10" style="width:372px;font-size:13px; font-weight:bold;" align="right">
  ...
  <tr>
    <td>Sub Total:</td>
    <td><input type="text" class="form-control"  name="sub_total" <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?> id="sub_total" readonly value="<?php echo stripslashes(getsales("sub_tot", $_REQUEST['lid'])); ?>"></td>
  </tr>
  <tr>
   <td>Discount:</td>
    <td><input type="text" class="form-control"  <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?> name="discount" id="discount" value="<?php echo stripslashes(getsales("discount", $_REQUEST['lid'])); ?>"></td>
    
  </tr>
  <tr>
    <td colspan="2">
        <div class="row" <?php if(getsales("gsttype", $_REQUEST['lid'])=='2') { ?> style="display:none;" <?php } else { ?> style="display:block;" <?php } ?> id="gstdisp">
    <div class="col-md-6" style="padding-right: 0px;">GST Value:</div>
       <div class="col-md-6"  style="padding-left: 20px;"><input class="form-control"  type="text" <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?> name="gstvalue" id="gstvalue" value="<?php echo stripslashes(getsales("gstvalue", $_REQUEST['lid'])); ?>"></div>
</div>
   </td>
  ...
  <!--<tr>
   ...
   <tr>
    ...
    <td><input type="text" name="tot_amt" class="form-control"  <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?> id="tot_amt" value="<?php echo stripslashes(getsales("total_amnt", $_REQUEST['lid'])); ?>"></td>
    
  </tr>
  <tr>
  <td>Due Amount:</td>
    <td width="45%"><input type="text" class="form-control"  name="given_amt" id="given_amt" value="<?php echo stripslashes(getsales("given_amnt", $_REQUEST['lid'])); ?>" <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?>></td>
   </tr>
  <tr>
    <td>Balance Amount:</td>
    <td><input type="text" class="form-control"  name="balance_amt" <?php if($_REQUEST['type']=='view') { ?>  readonly="readonly" <?php } ?> id="balance_amt" value="<?php echo getsales("balance_amnt", $_REQUEST['lid']); ?>"></td>
