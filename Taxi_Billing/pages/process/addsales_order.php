...
if($getrecr['id']==''){
                                                    ...
                                                    $qty=$objectsss1list['qty'];
                                                     ...
                                                     $resa = $db->prepare("INSERT INTO `temp_sales_details` (`mrp_price`,`hsn`,`gstresult`,`object_id`,`bill_no`,`product_name`,`qty`,`rate`,`total`) VALUES (?,?,?,?,?,?,?,?,?) ");
            $resa->execute(array($mprprice,$hsn,$gstresult,$object_id,$bill_no,$product_name,$qty,$rate,$total));
}
...
<td><input type="text" style="text-align: right;" readonly="readonly" name="mrp_price[]" id="mrp_price" class="form-control mrp_price"  /></td>
