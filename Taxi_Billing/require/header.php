...
function toggleSidebar() {
 const element = document.getElementById("sidebar_id");
  if (element.className == "skin-blue sidebar-mini skin-blue sidebar-mini") {
   ...
   <!--  <body  class="skin-blue sidebar-mini skin-blue sidebar-mini sidebar-collapse" id="sidebar_id"> -->
       <!--<body  class="skin-blue sidebar-mini skin-blue sidebar-mini sidebar-collapse" onload="startTime();" id="sidebar_id">-->
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="<?php echo $sitename; ?>" class="logo" style="background-color: #2AA8E5;">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini"><b>DTB</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Droptaxi BIlling</b></span>
                </a>
                <!-- Header Navbar: style can be found in header.less -->
                <nav class="navbar navbar-static-top" role="navigation" style="background-color: #2AA8E5;">
