...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=taxibilling;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/ttbilling/taxibilling/';
    $fsitename = 'http://localhost/ttbilling/taxibilling/';
    ...
    $db = new PDO('mysql:host=localhost;dbname=taxibilling;charset=utf8mb4', 'taxibilling', 'taxibilling');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "taxibilling", "taxibilling", "taxibilling");
    $sitename = "https://ttbilling.in/taxibilling/";
    $site = 'https://ttbilling.in/taxibilling/';
    $fsitename = 'https://ttbilling.in/taxibilling/';
